					...
					<div class="col-sm-12">
						<div class="card mb-0">
							<div class="card-header">
								<h4 class="card-title mb-0">Processos</h4>
								<p class="card-text">
    ...
    <script type="text/javascript">
        $(document).ready(function(e){
            ...
            $('.clickEditarAgenda').click(function(e){
                ...
                $.ajax({
                    url: '/app/robo/previa-agenda-antes/' + id,
                    method: 'GET',
                    success: function(res){
                        if(res.status == 'ok'){
                            console.log(res);
                            $('input[name=hidden_id]').val(res.response.id);
                            $('input[name=campo2]').val(res.response.campo2);
                            $('input[name=campo3]').val(res.response.campo3);
                            $('input[name=campo4]').val(res.response.campo4);
                            $('input[name=campo5]').val(res.response.campo5);
                            $('input[name=campo6]').val(res.response.campo6);
