            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title">Gerênciar Usuários</h3>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="/">Administração</a></li>
								<li class="breadcrumb-item active">Gerênciar Usuários</li>
							</ul>
						</div>
						<div class="col-auto float-right ml-auto">
							<a href="/app/usuarios/cadastrar" class="btn add-btn btnCadastrarNovo"><i class="fa fa-plus"></i> Cadastrar novo usuário</a>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-12">
						<div class="card mb-0">
							<div class="card-header">
								...
								<p class="card-text">
									Utilize esse página para gerênciar todos os usuários cadastrados
								</p>
							</div>
							<div class="card-body">
                                <?php
                                                    ...
                                                    foreach($sql as $dados){
                                                        ...
                                                        echo '
                                                            <tr>
                                                                ...
                                                                <td>'.$dados->email.'</td>
                                                                <td>
                                                                    <button class="btn" type="button" style="background-color: #'.$dados->backgroundColor.'; color: #'.$dados->textColor.';">
                                                                        Texto
                                                                    </button>
                                                                </td>
                                                                <td>'.$status.'</td>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a class="dropdown-item clickAlterarSenha" data-id="'.$dados->id.'" href="#">Alterar Senha</a>
                                                                    </div>
                                                                </div>
                                                                </td>
                                                            </tr>
