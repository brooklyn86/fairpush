					...
					<div class="col-sm-12">
						<div class="card mb-0">
							<div class="card-header">
								...
								<p class="card-text">
								      Digite os seus dados no formulário abaixo para alterar
								</p>
							</div>
							<div class="card-body">
                                <?php
                                ...
                                {{ Form::model($user, ['url' => ['app/meus-dados', ''], 'id' => 'form1']) }}
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                            <label>Para alterar sua senha, digite no campo abaixo a nova senha</label>
                                            {{ Form::password('password',  ['class' => 'form-control', 'placeholder' => 'Digite a sua nova senha aqui']) }}
                                        </div>
                                    </div>
