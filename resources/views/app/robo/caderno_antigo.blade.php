					...
					<div class="col-sm-12">
						<div class="card mb-0">
							<div class="card-header">
								<h4 class="card-title mb-0">Cadernos Antigo</h4>
								<p class="card-text">
									Listagem da plataforma antiga
								</p>
							</div>
							<div class="card-body">
                                <?php
                                            ...
                                            <?php
                                                if(count($sql) > 0){
                                                    foreach($sql as $dados){
                                                        ...
                                                        if($dados->status == 1){
                                                            $status = '<span class="badge bg-inverse-info">Caderno Extraido</span>';
                                                        }else{
                                                        ...
                                                        echo '
                                                            <tr>
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    if($dados->status == 1){
                                                                        echo '
                                                                        <a class="dropdown-item" data-id="'.$dados->id.'" href="/app/robo/visualizar-processos-antigos/'.$dados->id.'">Visualizar Atividade Crawler</a>
                                                                        ';
                                                                    }
                                                                    echo '
                                                                    <a class="dropdown-item" data-id="'.$dados->id.'" href="/app/robo/antes-expedir/'.$dados->id.'">Visualizar Processos antes de Expedir</a>
                                                                    ';
                                                                    echo '
                                                                    </div>
                                                                </div>
