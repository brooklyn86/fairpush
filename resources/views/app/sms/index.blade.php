            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title">Gerênciar SMS</h3>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="/">Administração</a></li>
								<li class="breadcrumb-item active">Gerênciar SMS</li>
							</ul>
						</div>
						<div class="col-auto float-right ml-auto">
							<a href="/app/sms/cadastrar" class="btn add-btn btnCadastrarNovo"><i class="fa fa-plus"></i> Cadastrar nova mensagem</a>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-12">
						<div class="card mb-0">
							<div class="card-header">
								<h4 class="card-title mb-0">SMS</h4>
								<p class="card-text">
									Utilize esse página para gerênciar as mensagens SMS cadastradas
								</p>
							</div>
							<div class="card-body">
                                <?php
    ...
    <script type="text/javascript">
        $(document).ready(function(e){
            $('.clickEditar').click(function(e){
                window.location.href = '/app/sms/editar/' + $(this).attr('data-id');
            });
            $('.clickExcluir').click(function(e){
                ...
                Swal.fire({
                    ...
                    text: "Tem certeza que deseja excluir esse mensagem?",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        window.location.href = '/app/sms/excluir/' + id;
                    }
                });
            });
        });
