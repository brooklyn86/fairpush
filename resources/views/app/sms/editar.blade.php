            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title">Editar Mensagem SMS</h3>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="/">Administração</a></li>
								<li class="breadcrumb-item active">Editar SMS</li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-12">
						<div class="card mb-0">
							...
							<div class="card-body">
								...
								{{ Form::model($sql, ['url' => ['app/sms/editar', $sql->id], 'id' => 'form1']) }}
                                    <div class="form-row">
